...
**Концевик** — используется для фиксирования события нажатия рычажка. Помещается в бампер робота для 
фиксирования удара об препятствие. события закрывания или открывания дверей и окон.
